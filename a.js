function initengahan(){
  ...
  async function menuju(){await swals.fire('Uci!', 'Nhớ phản hồi nhaaa =)) , không biết rủ được không nhưng mà có này tặng choo Kim Khánh nèe', 'success');window.location = "https://cuongnobro.github.io/Baby/";}
